...
export default class App {
  ...
  async _onLogin(event) {
    ...
    this._user = await User.loadOrCreate(this._loginForm.userid.value); //gọi đến phương thức loadOrCreate của lớp User
  ...
  async _loadProfile() {
    ...
    /* Reset the feed. */
    document.querySelector("#feed").textContent = ""; //reset lại feed
